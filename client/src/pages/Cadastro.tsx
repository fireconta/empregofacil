    ...
    try {
      ...
      reader.onload = async () => {
        ...
        if (GOOGLE_SCRIPT_URL) {
          // Usamos text/plain para evitar que o navegador faça uma requisição OPTIONS (preflight)
          // que o Google Apps Script não suporta. O script no Google vai ler o corpo como string e fazer o parse.
