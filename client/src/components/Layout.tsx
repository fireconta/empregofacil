        ...
        <div className="container grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href={APP_DOWNLOAD_LINK} className="hover:text-primary">Baixar Aplicativo</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><span className="cursor-pointer hover:text-primary">Anunciar Vaga</span></li>
